			...
			<div class="col-md-12">
				<div class="panel">
					...
					<div class="panel-body">
						...
						<form action="#" class="form-horizontal" method="#" id="form-penilaian">
								...
								<tbody>
									...
									<tr>
                                    	...
                                    	<td>
                                      		...
                                      		<input type="number" name="score[]" class="form-control" placeholder="Maks. 35" min="1" max="35" required="required" value="#">
                                    	</td>
									</tr>
									<tr>
                                    	<td>b</td>
                                    	...
                                    	<td>
                                      		...
                                      		<input type="number" name="score[]" class="form-control" placeholder="Maks. 40" min="1" max="40" required="required" value="#">
                                    	</td>
                                  	</tr>
                                  	<tr>
                                    	<td>c</td>
                                  	...
                                  	<tr>
                                    	<td colspan="3" align="center">Produk/Layanan</td>
                                  	</tr>
                                  	<tr>
                                    	<td>d</td>
                                    	...
                                    	<td>
                                      		...
                                      		<input type="number" name="score[]" class="form-control" placeholder="Maks. 25" min="1" max="25" required="required" value="#">
                                    	</td>
                                  	</tr>
                                  	<tr>
                                    	<td>e</td>
                                 	...
                                 	<tr>
                                  	...
                                  	<tr>
                                    	...
                                    	<td>
                                      		...
                                      		<input type="number" name="score[]" class="form-control" placeholder="Maks. 20" min="1" max="20" required="required" value="#">
                                    	</td>
                                  	</tr>
                                  	<tr>
                                  	...
                                  	<tr>
                                    	...
                                    	<td>
                                      		...
                                      		<input type="number" name="score[]" class="form-control" placeholder="Maks. 15" min="1" max="15" required="required" value="#">
                                    	</td>
                                  	</tr>
                                  	<tr>
                                    	<td>s</td>
