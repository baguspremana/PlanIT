	...
	<div id="wrapper">
        ...
        <div class="sidebar" style="background-color: #021B79">
            ...
            <div class="sidebar-scroll">
                <nav>
                    <ul class="nav">
                        <li><a href="/dashboard-jury"><i class="glyphicon glyphicon-dashboard"></i> <span>Dashboard</span></a></li>
                        <li><a href="#"><i class="glyphicon glyphicon-list-alt"></i> <span>Rekap Nilai</span></a></li>
                    </ul>
                </nav>
            </div>
        </div>
