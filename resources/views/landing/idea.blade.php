...
@section('title')
Pengembangan Ide Bisnis TIK - ITCC 2018
@endsection
...
<section id="hero">
    <div class="hero-container wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      	<h1>Cabang Lomba Pengembangan Ide Bisnis TIK</h1>
      	<h2>Uji Ide-mu Berbisnis dalam Bidang TIK</h2>
      	<div class="actions">
      		<a href="#profile" class="btn-detail">Selengkapnya</a>
      		<a href="/signup-idea" class="btn-daftar">Yuk Daftar!</a>
      	</div>
    </div>
</section><!-- #hero -->
