...
<section id="hero">
    <div class="hero-container wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      	<h1>Cabang Lomba Sistem Informasi</h1>
      	<h2>Uji Ide-mu dan Kemampuan Coding-mu</h2>
      	<div class="actions">
      		<a href="#profile" class="btn-detail">Selengkapnya</a>
      		<a href="/signup-si" class="btn-daftar">Yuk Daftar!</a>
      	</div>
    </div>
</section><!-- #hero -->
  	...
  	<div class="container wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms" style="margin-top: 50px; margin-bottom: 50px;">
  		...
  		<center>
	  		<div class="row col-md-9" style="margin-top: 40px;">
	  			<p style="font-size: 16px;">Sistem Informasi merupakan salah satu perlombaan yang ada dalam kegiatan ITCC 2018 yang diperuntukkan mahasiswa S1/Sederajat Se-Indonesia<br>Sistem Informasi bertujuan untuk menjaring masyarakat Indonesia untuk mengembangan ide bisnis melalui produk TIK.<br>Sistem Informasi merupakan jenis perlombaan bertim, dimana setiap tim terdiri dari 3 orang dengan biaya pendaftaran Rp. 150.000,- untuk setiap tim.</p>
	  		</div>
    	...
    	<div class="row" style="margin-top: 50px;">
		    ...
		    <div class="col-lg-6">
		        <div class="box wow fadeInLeft">
		          	<div class="icon"><i class="fa fa-code" style="padding-top: 40px;"></i></div>
		          	<h4 class="title">Pemrograman</h4>
		          	<p class="description justify">Cabang Lomba <b>Pemrograman</b> diperuntukan kepada siswa SMA/SMK Sederajat se-Bali. Biaya Pendaftaran Rp. 85.000,-</p>
		          	<a href="/pemrograman" class="btn-get-started">Selengkapnya</a>
		        </div>
		    </div>
		    ...
		    <div class="col-lg-6">
		        <div class="box wow fadeInRight">
		          	...
		          	<a href="/desain-web" class="btn-get-started">Selengkapnya</a>
		        </div>
		    </div>
    	...
    	<div class="row">
		    ...
		    <div class="col-lg-6">
		        <div class="box wow fadeInLeft">
		          	...
		          	<a href="/cerdas-cermat" class="btn-get-started" style="margin-bottom: 25px;">Selengkapnya</a>
		        </div>
		    </div>
