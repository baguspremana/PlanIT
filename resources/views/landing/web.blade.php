...
<section id="hero">
    <div class="hero-container wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="300ms">
      	<h1>Cabang Lomba Desain Web</h1>
      	<h2>Uji Kreatifitas-mu dan Coding-mu</h2>
      	<div class="actions">
      		<a href="#profile" class="btn-detail">Selengkapnya</a>
      		<a href="/signup-web" class="btn-daftar">Yuk Daftar!</a>
      	</div>
    </div>
</section><!-- #hero -->
